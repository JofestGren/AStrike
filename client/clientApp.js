...
Img.map['field'].src = '/client/img/map.jpg';
Img.map['forest'] = new Image();
Img.map['forest'].src = '/client/img/map2.jpg';

var ctx = document.getElementById("ctx").getContext("2d");
var ctxUi = document.getElementById("ctx-ui").getContext("2d");
ctxUi.font = '30px Gochi Hand';
...
var drawScore = function () {
    ...
    // ctxUi.fillStyle = '#ff5700';
    // ctxUi.fillText("Score: " + Player.list[selfId].score, 20, 30);
    var valueScoreZero = "Score: " + 0;
    document.getElementById('score').innerHTML = valueScoreZero;
    var valueScore = "Score: " + Player.list[selfId].score;
    document.getElementById('score').innerHTML = valueScore;
}
